...
class DraftOrderModel(Base):
    ...
    source_type = Column(Enum('VOICE', 'TEXT', 'ZALO', 'PHONE', name="DraftOrderSourceTypeEnum"), nullable=False)
    ...
    draft_status = Column(Enum('PENDING', 'CONFIRMED', 'REJECTED', 'EDITED', name="DraftStatusEnum"), nullable=False)
